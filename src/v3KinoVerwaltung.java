...
public class v3KinoVerwaltung {
    public static void main(String[] args) {
        ...
        int walletBalance;
        boolean exit = false;
        while (!exit) {                                                //continueshopping schleife bis ganz unten
            ...
            //hier wird der geld betrag gespeichert und geprüft ob genug für ein ticket vorhanden ist
            do {
...
// noch zu checken Problem bei welchen nicht ausgebuchten film willst du sehen nach eingabe 0
